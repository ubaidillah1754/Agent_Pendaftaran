    ...
    <div class="card-body p-4 p-md-5">
        ...
        <div class="d-flex align-items-start justify-content-between flex-wrap gap-3 mb-4 pb-4 border-bottom">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h5 class="mb-1 fw-700">Edit Dokter — {{ $doctor->nama_dokter }}</h5>
                    <p class="text-muted mb-0" style="font-size:.85rem;">Perbarui informasi data dokter dengan lengkap dan benar.</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    @if($doctor->foto)
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <img src="{{ asset('storage/'.$doctor->foto) }}" style="height:56px;width:56px;object-fit:cover;border-radius:10px;" alt="Foto">
