...
<div class="row g-4">
    ...
    <div class="col-12">
        <div class="card fade-in">
            <div class="card-body py-4 d-flex flex-wrap align-items-center gap-4">
                <div style="width:80px;height:80px;flex:0 0 auto;border-radius:22px;background:{{ $patient->jenis_kelamin==='L'?'var(--primary)':'#be185d' }};
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-2" style="font-size:.8rem;">
                        ...
                        <span class="badge" style="background:{{ $statusPasien==='aktif'?'#dcfce7':'#fee2e2' }};color:{{ $statusPasien==='aktif'?'#166534':'#991b1b' }};">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('patients.edit', $patient) }}" class="btn" style="background:#eff6ff;color:var(--primary);">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('patients.edit', $patient) }}"><i class="bi bi-pencil me-2"></i>Edit Data</a></li>
                            <li><a class="dropdown-item text-danger" href="#" onclick="event.preventDefault(); document.getElementById('delete-patient-form').submit();"><i class="bi bi-trash me-2"></i>Hapus Pasien</a></li>
                        </ul>
                        <form id="delete-patient-form" action="{{ route('patients.destroy', $patient) }}" method="POST" class="d-none">
                            @csrf @method('DELETE')
                        </form>
                    </div>
                </div>
    ...
    <div class="col-6 col-lg-3">
        <div class="card fade-in h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="btn-icon" style="width:44px;height:44px;background:#eff6ff;color:var(--primary);border-radius:12px;display:flex;align-items:center;justify-content:center;">
    ...
    <div class="col-6 col-lg-3">
        <div class="card fade-in h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="btn-icon" style="width:44px;height:44px;background:#f0f9ff;color:#0891b2;border-radius:12px;display:flex;align-items:center;justify-content:center;">
    ...
    <div class="col-6 col-lg-3">
        <div class="card fade-in h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="btn-icon" style="width:44px;height:44px;background:#dcfce7;color:#166534;border-radius:12px;display:flex;align-items:center;justify-content:center;">
    ...
    <div class="col-6 col-lg-3">
        <div class="card fade-in h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="btn-icon" style="width:44px;height:44px;background:#fef3c7;color:#92400e;border-radius:12px;display:flex;align-items:center;justify-content:center;">
        ...
        <div class="card fade-in">
            ...
            <div class="card-body py-3">
                ...
                <div class="d-flex justify-content-center mb-3">
                    <div style="width:120px;height:120px;border:1px dashed #cbd5e1;border-radius:12px;display:flex;align-items:center;justify-content:center;color:#94a3b8;">
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    @endif
                    @if(Route::has('patients.exportPdf'))
                    <a href="{{ route('patients.exportPdf', $patient) }}" class="btn w-100" style="background:var(--bg);">
    ...
    <div class="col-lg-5">
        <div class="card fade-in">
            ...
            <div class="card-body py-3">
                <div class="row">
                    <div class="col-6">
                        <div class="mb-2" style="font-size:.83rem;">
                            <div class="text-muted">NIK</div><span style="font-family:monospace;">{{ $patient->nik }}</span>
                        </div>
                        <div class="mb-2" style="font-size:.83rem;">
                            <div class="text-muted">No. Rekam Medis</div><span style="font-family:monospace;">{{ $patient->no_rm }}</span>
                        </div>
                        <div class="mb-2" style="font-size:.83rem;">
                    ...
                    <div class="col-6">
                        ...
                        <div style="font-size:.83rem;">
                            <div class="text-muted">No. BPJS</div><span style="font-family:monospace;">{{ $noBpjs ?? '-' }}</span>
                        </div>
                    </div>
                </div>
                <hr>
        ...
        <div class="card mt-3 fade-in">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="font-size:.82rem;">{{ $reg->tanggal_daftar->format('d M Y') }}<br><span class="text-muted" style="font-size:.72rem;">{{ $reg->tanggal_daftar->format('H:i') }} WIB</span></td>
                            ...
                            <td style="font-size:.82rem;">
                                <span class="badge" style="background:#d1fae5;color:#065f46;">{{ strtoupper($reg->jenis_pembayaran ?? $patient->jenis_pembayaran) }}</span>
                            </td>
            ...
            <div class="card-footer d-flex justify-content-between align-items-center" style="font-size:.8rem;">
                <span class="text-muted">Menampilkan 1 - {{ $patient->registrations->count() }} dari {{ $patient->registrations->count() }} data</span>
            </div>
            @endif
        </div>
    </div>
        ...
        <div class="card fade-in">
            ...
            <div class="card-body py-3">
                <div class="d-flex align-items-center gap-2 mb-3">
                    <div class="btn-icon" style="width:34px;height:34px;background:#eff6ff;color:var(--primary);border-radius:10px;display:flex;align-items:center;justify-content:center;">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    <div class="btn-icon" style="width:34px;height:34px;background:#f0f9ff;color:#0891b2;border-radius:10px;display:flex;align-items:center;justify-content:center;">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    <div class="btn-icon" style="width:34px;height:34px;background:#fef3c7;color:#92400e;border-radius:10px;display:flex;align-items:center;justify-content:center;">
                        <i class="bi bi-hospital"></i>
                    </div>
                    <div class="flex-grow-1">
                        <div class="text-muted" style="font-size:.72rem;">Poli Terakhir</div>
                        <div class="fw-800" style="font-size:.85rem;">{{ $lastReg?->department?->nama_poli ?? '-' }}</div>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-2 mb-3">
                    <div class="btn-icon" style="width:34px;height:34px;background:#dcfce7;color:#166534;border-radius:10px;display:flex;align-items:center;justify-content:center;">
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="btn-icon" style="width:34px;height:34px;background:#fee2e2;color:#991b1b;border-radius:10px;display:flex;align-items:center;justify-content:center;">
